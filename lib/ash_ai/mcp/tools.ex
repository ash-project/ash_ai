defmodule AshAi.Mcp.Tools do
  @moduledoc """
  MCP Tools capability for AshAi.

  This capability integrates AshAi tools with the MCP protocol,
  ...
  if Code.ensure_loaded?(AshMcp) do
    ...
    def handle_method("tools/call", params, session_id, opts) do
      ...
      case find_ash_tool(tool_name, opts) do
        nil ->
    ...
    defp find_ash_tool(tool_name, opts) do
      get_ash_tools(opts)
